            ...
            <div class="modal-body">
                <form action="<?= URL; ?>/pelanggan/save" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="kode" class="form-control" id="kode" aria-describedby="kodeHelp" name="kode"
                            required readonly value="<?= $data['genKodePel']; ?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="seri" class="form-label">No Seri PLN <sup
                                class="text-danger fw-bold">*</sup></label>
                        <input type="number" class="form-control" id="seri" name="seri" required readonly
                            value="<?= $data['genNoSeri']; ?>">
                    </div>
                    <div class="mb-3">
                        <label for="meteran" class="form-label">No Meteran <sup
                                class="text-danger fw-bold">*</sup></label>
                        <input type="number" class="form-control" id="meteran" name="meteran" required readonly
                            value="<?= $data['genMeteran']; ?>">
                    </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?= URL; ?>/pelanggan/edit/<?= $row['pel_id']; ?>"
                                class="btn btn-warning fw-bold text-white">Edit</a>
                            <a href="<?= URL; ?>/pelanggan/delete/<?= $row['pel_id']; ?>" class="btn btn-danger fw-bold"
                                onclick="return confirm('Apakah anda ingin menghapus data ini?')">X</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
